    ...
    <form action="{{ route('audit.answer-review.store') }}" method="POST" id="reviewForm">
        ...
        <div class="card mb-4">
            ...
            <div class="card-header">
                ...
                <small class="text-muted">
                    Sila semak dan pilih keputusan bagi setiap senarai semak.
                </small>
            ...
            <div class="card-body">
                ...
                @empty
                    ...
                    <div class="alert alert-info mb-0">
                        Tiada senarai semak untuk item audit ini.
                    </div>
                @endforelse
            ...
            */
            ...
            if (!valid) {
                ...
                Swal.fire({
                    ...
                    text: 'Sila pilih Akur, Tidak Akur atau Tidak Berkaitan bagi semua senarai semak.'
