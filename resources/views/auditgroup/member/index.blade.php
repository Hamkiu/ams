<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="{{ $isLocked ? 'col-md-12' : 'col-md-8' }} mb-4">
                <h5 class="mb-0">
                    Senarai Juruaudit
                </h5>
                <br />
            ...
            @if (!$isLocked)
                <div class="col-md-4" style="background-color: #EBEBEB;">
                    <hr />
                    <form role="form" id="auditGroupMemberForm" name="auditGroupMemberForm" method="post"
                        action="{{ route('auditgroupmember.store', encode($auditGroup->id)) }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-4">
                                    ...
                                    <select name="user_id" class="form-control" id="user_id">
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" data-jabatan="{{ $user->jabatan }}">
                                                {{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="jabatan_member" id="jabatan_member" class="form-control"
                                        placeholder="Jabatan / Unit" readonly>
                                </div>
                            </div>
                        </div>
