...
<div class="card-body">
    <form action="{{ route('user.store') }}" method="POST" id="create_user_form" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4">Tambah Pengguna</h5>
                        <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama Pengguna" readonly value="{{ old('name') }}">
                                      </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Jabatan" value="{{ old('jabatan') }}" readonly>
                                      </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="jawatan" name="jawatan" placeholder="Jawatan" value="{{ old('jawatan') }}" readonly>
                                      </div>
                                </div>
                            </div>
                            <div class="row mb-3">
